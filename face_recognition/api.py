...
# @Author : system
# @Version : 0.2.5
# @Program : 特征识别 API | Feature recognition API
# @File : api.py
# @Description : 特征识别 API 接口 | Feature recognition API interface
...
try:
    ...
    print("Please install `face_recognition_models` with this command before using `feature_recognition`:\n")
    print("pip install aiparkhub/core/data/feature_training_dataset/part_0/face_recognition_models")
    quit()
