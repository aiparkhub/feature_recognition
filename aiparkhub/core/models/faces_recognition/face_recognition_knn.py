...
# @Author : system
# @Version : 0.2.5
# @Program : 人像面部识别 - K最近邻KNN分类算法 人脸识别
# @File : face_recognition_knn.py
# @Description : Face recognition-K nearest neighbor KNN classification algorithm
...
COMMON_PATH = ABSOLUTE_PATH + 'aiparkhub/core/data/feature_training_dataset/part_3/'
RESOURCE_PATH_1 = COMMON_PATH + 'knn_classification_algorithm/train'
RESOURCE_PATH_2 = COMMON_PATH + 'knn_classification_algorithm/test'
...
def train(
    ...
    :param train_dir: directory that contains a sub-directory for each known person, with its name.
     ...
     (View in source core to see train_dir example tree structure)
...
if __name__ == "__main__":
    ...
    for image_file in os.listdir(RESOURCE_PATH_2):
        full_file_path = os.path.join(RESOURCE_PATH_2, image_file)
