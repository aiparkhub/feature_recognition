...
def capture(read_frame_list, Global, worker_num):
    ...
    video_capture = cv2.VideoCapture(RESOURCE_PATH_0)
...
def process(worker_id, read_frame_list, write_frame_list, Global, worker_num):
    ...
    while not Global.is_exit:
        ...
        while Global.read_num != worker_id or Global.read_num != prev_id(
            ...
            # If the user has requested to end the app, then stop waiting for
            # webcam frames
            if Global.is_exit:
                break
            time.sleep(0.01)
        ...
        # Find all the faces and face encodings in the frame of video, cost
        # most time
        ...
        for (
            ...
            cv2.putText(frame_process,
                        "Feature Counts : " + str(len(face_locations)),
                        (20,
                         100),
                        font,
                        1,
            ...
            cv2.putText(frame_process, "Stage Name : " + str(name),
            ...
            cv2.putText(
                ...
                2,
                cv2.LINE_AA)
            cv2.putText(frame_process, "Q: Quit Training Model", (20, 750),
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Create a thread to capture frames (if uses subprocess, it will crash
        # on Mac)
        p.append(
            threading.Thread(
                target=capture,
