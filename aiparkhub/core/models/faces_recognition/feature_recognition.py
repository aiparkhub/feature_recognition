...
def fast_training_model(training_dataset):
    ...
    obama_image = face_recognition.load_image_file(COMMON_PATH + "president_obama/dataset_for_photo/obama.jpg")
    obama_face_encoding = face_recognition.face_encodings(obama_image)[0]

    # Load a second sample picture and learn how to recognize it.
    biden_image = face_recognition.load_image_file(COMMON_PATH + "joe_biden/dataset_for_photo/biden.jpg")
    biden_face_encoding = face_recognition.face_encodings(biden_image)[0]

    # ==============================================================================================================

    # momoland_jooe_photo
    momoland_jooe_photo = face_recognition.load_image_file(COMMON_PATH + "momoland/dataset_for_photo/momoland_jooe.jpg")
    ...
    try:
        ...
        while True:
            ...
            # Resize frame of video to 1/4 size for faster face recognition processing, interpolation=cv2.INTER_NEAREST
            ...
            for (top, right, bottom, left), name in zip(face_locations, face_names):
                ...
                # Draw a box around the face, 255, 0, 0
                cv2.rectangle(frame, (left, top), (right, bottom), (255, 0, 0), 2)

                # Portrait Face Statistics (20, 100), (1600, 100),
                cv2.putText(frame, "Feature Counts : " + str(len(face_locations)), (20, 100), font, 1, (0, 255, 255), 3,
                            cv2.LINE_AA)

                cv2.putText(frame, "Stage Name : " + str(name), (20, 150), font, 1, (0, 255, 0), 3, cv2.LINE_AA)
            ...
            '''
            cv2.putText(frame, "Deep Learning - AiParkHub (Feature Recognition)", (20, 40), font, 1.5, (255, 0, 0),
                        2, cv2.LINE_AA)
            cv2.putText(frame, "N: Create Feature Folder", (20, 950), font, 0.8, (255, 0, 0), 2, cv2.LINE_AA)
            cv2.putText(frame, "S: Save Current Feature", (20, 1000), font, 0.8, (255, 0, 0), 2, cv2.LINE_AA)
            cv2.putText(frame, "Q: Quit Training Model", (20, 1050), font, 0.8, (255, 0, 0), 2, cv2.LINE_AA)
            ...
            # cv2.putText(frame, "N: Create Feature Folder", (20, 1900), font, 0.8, (240, 237, 232), 2, cv2.LINE_AA)
            # cv2.putText(frame, "S: Save Current Feature", (20, 2000), font, 0.8, (240, 237, 232), 2, cv2.LINE_AA)
            # cv2.putText(frame, "Q: Quit Training Model", (20, 2100), font, 0.8, (240, 237, 232), 2, cv2.LINE_AA)

            videoWriter.write(frame)

            # Display the resulting image
            cv2.imshow('Deep Learning - AiParkHub Organization (Feature Recognition)', frame)
...
def slow_training_model(training_dataset):
    ...
    videoWriter = cv2.VideoWriter('aiparkhub/core/data/feature_training_dataset/part_1/momoland/rendering_data/rendering_test_training_part_1.mp4', cv2.VideoWriter_fourcc('M', 'P', '4', '2'), 60, (w, h))
    ...
    try:
        ...
        while True:
            ...
            Visual information Style - 1
            '''
            cv2.putText(frame, "Deep Learning - AiParkHub (Feature Recognition)", (20, 40), font, 1.5, (240, 237, 232),
                        2, cv2.LINE_AA)
            cv2.putText(frame, "N: Create Feature Folder", (20, 950), font, 0.8, (240, 237, 232), 2, cv2.LINE_AA)
            cv2.putText(frame, "S: Save Current Feature", (20, 1000), font, 0.8, (240, 237, 232), 2, cv2.LINE_AA)
            cv2.putText(frame, "Q: Quit Training Model", (20, 1050), font, 0.8, (240, 237, 232), 2, cv2.LINE_AA)
...
if __name__ == '__main__':
    fast_training_model(RESOURCE_PATH_6)
    # slow_training_model(RESOURCE_PATH_6)
