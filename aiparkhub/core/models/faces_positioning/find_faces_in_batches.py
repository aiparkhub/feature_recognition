...
# @Description : Portrait Face Localization-Convolutional Neural Network Deep Learning Model Batch Recognition of Portrait Faces in Resources
...
RESOURCE_PATH_0 = COMMON_PATH + 'short_video/dataset_for_video/short_hamilton_clip.mp4'
